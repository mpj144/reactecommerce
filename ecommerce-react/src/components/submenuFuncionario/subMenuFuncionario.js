...
const SubMenuCliente = () => {
    ...
    return (
        ...
        <div className="sidebar">
            ...
            <Link className={currCount === 2} href="#deletar" onClick={() => onClickTab(2)} to="/DeletarFuncionario">
                <span className={currCount === 2}><i class="fas fa-arrow-right"></i>Deletar Funcionario</span>
            </Link>
